...
#nullable disable
#nullable restore
#line 8 "C:\C_WORKING\Clires_v3.0\CliresRDMS\CliresWeb\Pages\CliresSystem\Admin\Group\Create.razor"
           [Authorize(Roles = "GROUP_CREATE")]

#line default
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.LayoutAttribute(typeof(SystemLayout))]
    [Microsoft.AspNetCore.Components.RouteAttribute("/cliressystem/admin/group/addgroup")]
...
#nullable restore
#line 68 "C:\C_WORKING\Clires_v3.0\CliresRDMS\CliresWeb\Pages\CliresSystem\Admin\Group\Create.razor"
    ...
    async Task Save()
    {
        ...
        if (bSuccess)
        {
            ...
            await jsRuntime.InvokeVoidAsync("showAlert", "info", "Save change success");
